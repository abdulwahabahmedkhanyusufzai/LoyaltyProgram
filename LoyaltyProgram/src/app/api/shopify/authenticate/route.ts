...
export async function GET(req) {
  try {
    ...
    const scopes = `read_customers,write_content,read_content,read_products,write_products,write_files,read_files,write_online_store_navigation,read_online_store_navigation,write_publications,read_publications,write_product_listings,read_product_listings`;
