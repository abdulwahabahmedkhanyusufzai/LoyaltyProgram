...
const RewardBadge = ({ count, label }: { count: string; label: string }) => {
  return (
    <div className="flex items-center bg-[#2C2A25] text-white border border-[#2C2A25] rounded-[20px] 
                    w-[100px] sm:w-[120px] lg:w-[148px] 
                    h-[30px] sm:h-[36px] lg:h-[34px] 
                    px-2 sm:px-3 lg:px-4">
      {/* Circle */}
      <div className="flex justify-center items-center border border-[#FEFCED] rounded-full bg-[#FEFCED] 
                      w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] lg:w-[18px] lg:h-[30px] 
