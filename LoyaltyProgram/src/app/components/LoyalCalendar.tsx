...
const monthName = monthNames[month];
  ...
  return (
    <div className="w-full h-auto sm:w-[300px] sm:h-[400px] lg:w-[340px] lg:h-[500px] 2xl:w-[502px] 2xl:h-[526px] border border-[#2C2A25] rounded-[32px] p-4 sm:p-6 flex flex-col">
      {/* Header */}
