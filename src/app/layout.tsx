...
async function loadLocaleMessages(locale: string) {
    const messageFiles = ["stats", "loyaltyTable", "nav", "header", "analytics", "calendar", "tabs", "loyalCustomer", "sendEmail", "customer", "homeSection", "registerCustomer", "add-remove-loyal", "loyalCustomerManage", "loyaltyProgram"]; // add other files if needed
